...
UPDATE Pytania SET Obrazek = (SELECT * FROM OPENROWSET(BULK N'C:\Users\Mus\Documents\GitHub\Wzorce\content\gfx\01cre_singleton.png', SINGLE_BLOB) AS ORS) WHERE ID_pytania = 76;
UPDATE Pytania SET Obrazek = (SELECT * FROM OPENROWSET(BULK N'C:\Users\Mus\Documents\GitHub\Wzorce\content\gfx\02cre_factory.png', SINGLE_BLOB) AS ORS) WHERE ID_pytania = 77;
UPDATE Pytania SET Obrazek = (SELECT * FROM OPENROWSET(BULK N'C:\Users\Mus\Documents\GitHub\Wzorce\content\gfx\03cre_prototype.png', SINGLE_BLOB) AS ORS) WHERE ID_pytania = 78;
UPDATE Pytania SET Obrazek = (SELECT * FROM OPENROWSET(BULK N'C:\Users\Mus\Documents\GitHub\Wzorce\content\gfx\04cre_abstractfactory.png', SINGLE_BLOB) AS ORS) WHERE ID_pytania = 79;
UPDATE Pytania SET Obrazek = (SELECT * FROM OPENROWSET(BULK N'C:\Users\Mus\Documents\GitHub\Wzorce\content\gfx\05cre_builder.png', SINGLE_BLOB) AS ORS) WHERE ID_pytania = 80;
UPDATE Pytania SET Obrazek = (SELECT * FROM OPENROWSET(BULK N'C:\Users\Mus\Documents\GitHub\Wzorce\content\gfx\06str_proxy.png', SINGLE_BLOB) AS ORS) WHERE ID_pytania = 81;
UPDATE Pytania SET Obrazek = (SELECT * FROM OPENROWSET(BULK N'C:\Users\Mus\Documents\GitHub\Wzorce\content\gfx\07str_facade.png', SINGLE_BLOB) AS ORS) WHERE ID_pytania = 82;
UPDATE Pytania SET Obrazek = (SELECT * FROM OPENROWSET(BULK N'C:\Users\Mus\Documents\GitHub\Wzorce\content\gfx\08str_flyweight.png', SINGLE_BLOB) AS ORS) WHERE ID_pytania = 83;
UPDATE Pytania SET Obrazek = (SELECT * FROM OPENROWSET(BULK N'C:\Users\Mus\Documents\GitHub\Wzorce\content\gfx\09str_decorator.png', SINGLE_BLOB) AS ORS) WHERE ID_pytania = 84;
UPDATE Pytania SET Obrazek = (SELECT * FROM OPENROWSET(BULK N'C:\Users\Mus\Documents\GitHub\Wzorce\content\gfx\10str_composite.png', SINGLE_BLOB) AS ORS) WHERE ID_pytania = 85;
UPDATE Pytania SET Obrazek = (SELECT * FROM OPENROWSET(BULK N'C:\Users\Mus\Documents\GitHub\Wzorce\content\gfx\11str_adapter.png', SINGLE_BLOB) AS ORS) WHERE ID_pytania = 86;
UPDATE Pytania SET Obrazek = (SELECT * FROM OPENROWSET(BULK N'C:\Users\Mus\Documents\GitHub\Wzorce\content\gfx\12str_bridge.png', SINGLE_BLOB) AS ORS) WHERE ID_pytania = 87;
UPDATE Pytania SET Obrazek = (SELECT * FROM OPENROWSET(BULK N'C:\Users\Mus\Documents\GitHub\Wzorce\content\gfx\13beh_iterator.png', SINGLE_BLOB) AS ORS) WHERE ID_pytania = 88;
UPDATE Pytania SET Obrazek = (SELECT * FROM OPENROWSET(BULK N'C:\Users\Mus\Documents\GitHub\Wzorce\content\gfx\14beh_interpreter.png', SINGLE_BLOB) AS ORS) WHERE ID_pytania = 89;
UPDATE Pytania SET Obrazek = (SELECT * FROM OPENROWSET(BULK N'C:\Users\Mus\Documents\GitHub\Wzorce\content\gfx\15beh_chainofresponsibility.png', SINGLE_BLOB) AS ORS) WHERE ID_pytania = 90;
UPDATE Pytania SET Obrazek = (SELECT * FROM OPENROWSET(BULK N'C:\Users\Mus\Documents\GitHub\Wzorce\content\gfx\16beh_mediator.png', SINGLE_BLOB) AS ORS) WHERE ID_pytania = 91;
UPDATE Pytania SET Obrazek = (SELECT * FROM OPENROWSET(BULK N'C:\Users\Mus\Documents\GitHub\Wzorce\content\gfx\17beh_templatemethod.png', SINGLE_BLOB) AS ORS) WHERE ID_pytania = 92;
UPDATE Pytania SET Obrazek = (SELECT * FROM OPENROWSET(BULK N'C:\Users\Mus\Documents\GitHub\Wzorce\content\gfx\18beh_observer.png', SINGLE_BLOB) AS ORS) WHERE ID_pytania = 93;
UPDATE Pytania SET Obrazek = (SELECT * FROM OPENROWSET(BULK N'C:\Users\Mus\Documents\GitHub\Wzorce\content\gfx\19beh_visitor.png', SINGLE_BLOB) AS ORS) WHERE ID_pytania = 94;
UPDATE Pytania SET Obrazek = (SELECT * FROM OPENROWSET(BULK N'C:\Users\Mus\Documents\GitHub\Wzorce\content\gfx\20beh_memento.png', SINGLE_BLOB) AS ORS) WHERE ID_pytania = 95;
UPDATE Pytania SET Obrazek = (SELECT * FROM OPENROWSET(BULK N'C:\Users\Mus\Documents\GitHub\Wzorce\content\gfx\21beh_state.png', SINGLE_BLOB) AS ORS) WHERE ID_pytania = 96;
UPDATE Pytania SET Obrazek = (SELECT * FROM OPENROWSET(BULK N'C:\Users\Mus\Documents\GitHub\Wzorce\content\gfx\22beh_strategy.png', SINGLE_BLOB) AS ORS) WHERE ID_pytania = 97;
UPDATE Pytania SET Obrazek = (SELECT * FROM OPENROWSET(BULK N'C:\Users\Mus\Documents\GitHub\Wzorce\content\gfx\23beh_command.png', SINGLE_BLOB) AS ORS) WHERE ID_pytania = 98;
UPDATE Pytania SET Obrazek = (SELECT * FROM OPENROWSET(BULK N'C:\Users\Mus\Documents\GitHub\Wzorce\content\gfx\24beh_activeobject.png', SINGLE_BLOB) AS ORS) WHERE ID_pytania = 99;
UPDATE Pytania SET Obrazek = (SELECT * FROM OPENROWSET(BULK N'C:\Users\Mus\Documents\GitHub\Wzorce\content\gfx\25beh_mvc.png', SINGLE_BLOB) AS ORS) WHERE ID_pytania = 100;
UPDATE Pytania SET Obrazek = (SELECT * FROM OPENROWSET(BULK N'C:\Users\Mus\Documents\GitHub\Wzorce\content\gfx\26beh_mvp.png', SINGLE_BLOB) AS ORS) WHERE ID_pytania = 101;
UPDATE Pytania SET Obrazek = (SELECT * FROM OPENROWSET(BULK N'C:\Users\Mus\Documents\GitHub\Wzorce\content\gfx\27beh_mvvm.png', SINGLE_BLOB) AS ORS) WHERE ID_pytania = 102;
GO
